            ...
            <form method="post" action="notice_list">
                <div class="search_style" style="margin-left: 20px">
                    <ul class="search_content clearfix">
                        <li><label class="l_f">标题</label><input name="name" type="text" value=""
...
<c:if test="${role.enName == 'admin'}">
    ...
    <div class="margin clearfix">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a title="详情" onclick="details(${c.id})" href="javascript:;"
                               class="btn btn-xs btn-info"><i class="fa fa-eye bigger-120"></i></a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
        ...
        <!-- 分页开始 -->
        <div class="pagelist">
            <pg:pager url="${ctx}/notice_list" maxIndexPages="5" items="${pagers.total}" maxPageItems="5"
...
<script type="text/javascript">
    function edit(id) {
        layer.open({
            type: 2,
            area: ['910px', '500px'],
            content: ['notice_edit?id=' + id, 'no']  //这里content是一个URL，如果你不想让iframe出现滚动条，你还可以content: ['http://sentsin.com', 'no']
        });
    ...
    function details(id) {
        layer.open({
            type: 2,
            area: ['910px', '500px'],
            content: ['notice_details?id=' + id, 'no']  //这里content是一个URL，如果你不想让iframe出现滚动条，你还可以content: ['http://sentsin.com', 'no']
        });
    ...
    function add() {
        layer.open({
            type: 2,
            area: ['710px', '600px'],
            content: ['notice_add', 'no']  //这里content是一个URL，如果你不想让iframe出现滚动条，你还可以content: ['http://sentsin.com', 'no']
        });
    }
