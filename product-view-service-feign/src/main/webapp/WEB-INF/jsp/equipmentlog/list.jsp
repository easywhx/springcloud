...
<div class="page-content clearfix">
    <div id="Member_Ratings">
        <div class="d_Confirm_Order_style">
            ...
            <div class="search_style">
                <ul class="search_content clearfix">
                    <%--<li><label class="l_f">设备名称及型号</label><input name="equipment.xh" type="text" value="${equipmentLog.equipment.xh}" class="text_add"  style=" width:200px"/></li>--%>
            ...
            <form  method="post" action="equipmentlog_export">
       ...
       <span class="l_f">
        <button type="submit" id="export-btn" class="btn btn-warning"><i class="icon-plus"></i>导出表格</button>
       	<a href="equipmentlog_stats" class="btn btn-xs btn-success">图表统计</a>
       </span>
                </div>
            </form>
    ...
    <!-- 分页开始 -->
    <div class="pagelist">
        <pg:pager url="${ctx}/equipmentlog_list.do" maxIndexPages="5" items="${pagers.total}" maxPageItems="5"
