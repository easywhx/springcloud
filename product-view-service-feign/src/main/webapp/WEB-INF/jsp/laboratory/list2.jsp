...
<div class="page-content clearfix">
    <div id="Member_Ratings">
        <div class="d_Confirm_Order_style">
            <form method="post" action="laboratory_list2">
    ...
    <!-- 分页开始 -->
    <div class="pagelist">
        <pg:pager url="${ctx}/laboratory_list2.do" maxIndexPages="5" items="${pagers.total}" maxPageItems="5"
...
<script>
    function yy(id) {
        updateId("laboratory_yy", "预约成功", id);
    }
