        ...
        <div class="d_Confirm_Order_style">
            ...
            <div class="search_style">
                <ul class="search_content clearfix">
                  <p style="font-size:18px;color: black"> 规章制度：
实验室管理规章制度<br/>
1.严禁将食品和零食带入实验室,严禁在实验室内吸烟,保持实验室环境整洁<br/>
2.进入实验室,按规定位置就坐,保持室内安静严禁喧哗戏闹,不做与实验无关的事情<br/>
3.实验时必须认真倾听教师讲解,观看教师示范操作,阅读实验指导书及有关资料。<br/>
4.未经实验指导老师允许不得擅自动用实验室内的设备。不得将实验室工具、仪器、仪表、器材等带出室外。<br/>
5.实验过程中应细心专研,勤于思考,努力提高实验操作水平。切忌对实验内容一知半解的情况下进行操作,不懂的地方同学之间相互探讨,或向指导老师请教<br/>
6.实验结束时,应将所使用的仪器、仪表、工具及测试电缆、连线等归位。非正常损坏或丢失的设备、器材、工具等应照价赔偿<br/>
7.实验室下课前,指导老师应安排和督促学生将板凳归位,整理和清扫实验室。督促学生关闭窗户、室内照明,关闭实验室电源总开关。指导老师在检查确认后方能允许学生离开实验室。<br/>
8.实验指导老师应认真填写实验室《实验、实训运行记录》本。<br/>
9.实验室管理人员负责本实验室的日常管理,确保实验室设备、仪器、仪表的完好。 </p>
    ...
    <!--
    <div class="pagelist">
        <pg:pager url="${ctx}/laboratory_listcopy.do" maxIndexPages="5" items="${pagers.total}" maxPageItems="5"
