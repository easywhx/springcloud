...
<div class="page-content clearfix">
    <div id="Member_Ratings">
        <div class="d_Confirm_Order_style">
            <form method="post" action="laboratory_list">
            <div class="search_style">
                <ul class="search_content clearfix">
                    <li><label class="l_f">实验室名称</label><input name="name" type="text" value="" class="text_add"  style=" width:200px"/></li>
                    <li><label class="l_f">负责人</label><input name="fzr" type="text" value="" class="text_add"  style=" width:200px"/></li>
       ...
       <span class="l_f">
        <a href="javascript:void(0)" id="member_add" class="btn btn-warning"><i class="icon-plus"></i>添加实验室</a>
       </span>
            </div>
            <!---->
    ...
    <!-- 分页开始 -->
    <div class="pagelist">
        <pg:pager url="${ctx}/laboratory_list" maxIndexPages="5" items="${pagers.total}" maxPageItems="5"
...
<div class="add_menber" id="add_menber_style" style="display:none">
    <ul>
        ...
        <li class="adderss">
                <label class="label_name"style="width: 130px">负责人：</label>
                <span class="add_name">
            <input name="fzr" type="text" id="负责人" class="text_add" style=" width:350px" value=""/>
        </span>
            </li>
...
//                                    parent.layer.close(index); //再执行关闭
    ...
    function edit(id) {
        layer.open({
            type: 2,
            area: ['910px', '500px'],
            content: ['laboratory_edit?id=' + id, 'no']  //这里content是一个URL，如果你不想让iframe出现滚动条，你还可以content: ['http://sentsin.com', 'no']
        });
    }
