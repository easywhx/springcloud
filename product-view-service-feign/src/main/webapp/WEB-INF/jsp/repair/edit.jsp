...
<body>
<!--添加用户图层-->
<form action="repair_add" method="post" class="form form-horizontal" id="add" >
    <%--<input value="${bean.id}" name="id"  type="hidden" class="text_add"/>--%>
    <div class="add_menber" id="add_menber_update">
        <ul>
            <%--<li>--%>
                <%--<label class="label_name" style="width: 130px">设备名称及型号：</label>--%>
                <%--<span class="add_name">--%>
                <%--<input value="${bean.xh}" name="sbxlh" type="text" id="设备名称及型号" class="text_add" />--%>
                <%--</span>--%>
            <%--</li>--%>
            <li>
                <label class="label_name"style="width: 130px">设备序列号：</label>
                <span class="add_name">
                <input name="equipment_id" type="text" id="设备序列号" class="text_add" value="${bean.sbxlh}"/>
                </span>
            </li>
            <li>
                <label class="label_name" style="width: 130px">报修原因：</label>
                <span class="add_name">
                <input name="bz" type="text" id="报修原因" class="text_add" value="${bean.zzs}"/>
                </span>
            <li class="adderss">
                <label class="label_name" style="width: 130px">报修人：</label>
                <span class="add_name">
                <input name="title" type="text" id="报修人" class="text_add" style=" width:350px" value="${bean.sbxlh}"/>
                </span>
            </li>
            <li class="adderss">
                <label class="label_name" style="width: 130px">报修位置：</label>
                <span class="add_name">
                <input name="wz" type="text" id="报修位置" class="text_add" style=" width:350px" value="${bean.bz}"/>
                </span>
            </li>
        </ul>
    </div>
