...
<div class="page-content clearfix">
    <div id="Member_Ratings">
        <div class="d_Confirm_Order_style">
            <form method="post" action="repair_repairlist">
            <div class="search_style">
                <ul class="search_content clearfix">
                    <li><label class="l_f">设备名称及型号</label><input name="xh" type="text" value="${repairLog.equipment.xh}" class="text_add"  style=" width:200px"/></li>
                    <li><label class="l_f">设备制造商</label><input name="zzs" type="text" value="${repairLog.equipment.zzs}" class="text_add"  style=" width:200px"/></li>
                ...
                <table class="table table-striped table-bordered table-hover" id="sample-table">
                    ...
                    <tbody>
                      <c:forEach items="${pgs}" var="c" varStatus="l">
                        ...
                        <td class="td-manage">
                            <c:if test="${c.isBx == 0}"><a title="报修" onclick="bx(${c.id})" href="javascript:;"  class="btn btn-xs btn-info" ><i class="icon-edit bigger-120"></i></a></c:if>
    ...
    <!-- 分页开始 -->
    <div class="pagelist">
        <pg:pager url="${ctx}/repair_repairlist.do" maxIndexPages="5" items="${pagers.total}" maxPageItems="5"
...
<form action="repair_repair" method="post" class="form form-horizontal" id="form-user-add" >
    <input type="hidden" name="equipment_id" id="equipmentId" value=""/>
    <div class="add_menber" id="add_menber_style" style="display:none">
        <ul>
            <li><label class="label_name" style="width: 130px">报修人：</label>
                <span class="add_name">
                <input value="" name="title" type="text" id="报修人" class="text_add"/>
            </span>
            </li>
            <li>
                <label class="label_name"style="width: 130px">报修原因：</label>
                <span class="add_name">
            <input name="bz" type="text" id="报修原因" class="text_add"/>
        </span>
            </li>
            <li class="adderss"><label class="label_name" style="width: 130px">设备位置：</label>
                <span class="add_name">
                <input name="wz" type="text" id="设备位置" class="text_add" style=" width:350px"/>
            </span>
            </li>
