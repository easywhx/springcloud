...
<div class="page-content clearfix">
            ...
            <form method="post" action="repair_list.do">
                <div class="search_style">
                    <ul class="search_content clearfix">
                        <li><label class="l_f">设备名称及型号</label><input name="equipment.xh" type="text" value="${bean.xh}"
             ...
             -->
            <form  method="post" action="repair_export">
        ...
        <button type="submit" id="member_add" class="btn btn-warning"><i class="icon-plus"></i>导出表格</button>
            ...
            <div class="table_menu_list">
                <table class="table table-striped table-bordered table-hover" id="sample-table">
                    ...
                    <tbody>
                    <c:forEach items="${pgs}" var="c" varStatus="status">
                        <tr>
    ...
    <!-- 分页开始 -->
    <div class="pagelist">
        <pg:pager url="${ctx}/repair_list.do" maxIndexPages="5" items="${pagers.total}" maxPageItems="5"
