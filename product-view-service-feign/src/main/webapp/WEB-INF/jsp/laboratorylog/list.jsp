...
<div class="page-content clearfix">
    <div id="Member_Ratings">
        <div class="d_Confirm_Order_style">
            <form  method="post" action="laboratorylog_export">
       ...
       <span class="l_f">
        <button type="submit" id="export-btn" class="btn btn-warning"><i class="icon-plus"></i>导出表格</button>
       	<a href="laboratorylog_stats" class="btn btn-xs btn-success">图表统计</a>
       </span>
                </div>
            </form>
            <%--<form method="post" action="laboratorylog_list">--%>
            <%--<div class="search_style">--%>
                <%--<ul class="search_content clearfix">--%>
                    <%--&lt;%&ndash;<li><label class="l_f">实验室名称</label><input name="laboratory.name" type="text" value="${laboratoryLog.laboratory.name}" class="text_add"  style=" width:200px"/></li>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<li><label class="l_f">预约人</label><input name="user.name" type="text" value="${laboratoryLog.user.name}" class="text_add"  style=" width:200px"/></li>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<li style="width:90px;"><button type="submit" class="btn_search"><i class="icon-search"></i>查询</button></li>&ndash;%&gt;--%>
                	<%--<li><a href="laboratorylog_stats" class="btn btn-xs btn-success">图表统计</a></li>--%>
                <%--</ul>--%>
            <%--</div>--%>
                <%--</form>--%>
    ...
    <!-- 分页开始 -->
    <div class="pagelist">
        <pg:pager url="${ctx}/laboratorylog_list" maxIndexPages="5" items="${pagers.total}" maxPageItems="5"
