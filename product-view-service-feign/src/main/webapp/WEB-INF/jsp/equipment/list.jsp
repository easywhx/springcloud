...
<div class="page-content clearfix">
    <div id="Member_Ratings">
        <div class="d_Confirm_Order_style">
            <form method="post" action="equipment_list">
            <div class="search_style">
                <ul class="search_content clearfix">
                    <li><label class="l_f">设备名称及型号</label><input name="xh" type="text" value="" class="text_add"  style=" width:200px"/></li>
                    <li><label class="l_f">设备制造商</label><input name="zzs" type="text" value="" class="text_add"  style=" width:200px"/></li>
                    <!-- <li><label class="l_f">设备序列号</label><input name="sbxlh" type="text" value="" class="text_add"  style=" width:200px"/></li> -->
       ...
       <span class="l_f">
        <a href="javascript:void()" id="member_add" class="btn btn-warning"><i class="icon-plus"></i>添加设备</a>
       </span>
            </div>
    ...
    <!-- 分页开始 -->
    <div class="pagelist">
        <pg:pager url="${ctx}/equipment_list.do" maxIndexPages="5" items="${pagers.total}" maxPageItems="5"
...
<!--添加用户图层-->
<form action="equipment_save" method="post" class="form form-horizontal" id="form-user-add" >
<div class="add_menber" id="add_menber_style" style="display:none">
    <ul>
        <li><label class="label_name" style="width: 130px">设备名称及型号：</label>
            <span class="add_name">
...
<script>
        ...
        layer.open({
            ...
            yes:function(index,layero){
                ...
                if(num>0){
                    ...
                    AJAX2("equipment_save", "添加成功", "form-user-add");
                }
            }
        });
    });
    ...
    function edit(id) {
        layer.open({
            type: 2,
            area: ['910px', '500px'],
            content: ['equipment_edit?id=' + id, 'no']  //这里content是一个URL，如果你不想让iframe出现滚动条，你还可以content: ['http://sentsin.com', 'no']
        });
    }
    /*用户-删除*/
    function member_del(obj,id){
        layer.confirm('确认要删除吗？',function(index){
           updateId("equipment_delete", "删除成功", id)
        });
    }
    laydate({
        elem: '#start',
