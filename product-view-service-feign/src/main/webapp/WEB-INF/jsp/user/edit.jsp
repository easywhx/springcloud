...
<body>
<form action="bean_update" method="post" class="form form-horizontal" id="form-bean-add" >
...
<div class="xinxi" style="margin-top: 20px">
    ...
    <div class="form-group"><label class="col-sm-3 control-label no-padding-right" for="form-field-1">学号或工号： </label>
...
<script>
    ...
    function save_info(){
        ...
        if(num>0){  return false;}
            ...
            AJAX("user_update", "修改成功", "form-bean-add");
        ...
        layer.open({
            ...
            yes:function(index, layero){
                ...
                if(!$("#c_mew_pas").val || $("#c_mew_pas").val() != $("#Nes_pas").val() )
                {
                    ...
                    $.ajax({
                    	url:'user_updatePw',
                    	data:{id:'${bean.id}',pass:$("#Nes_pas").val()},
