    ...
    <div id="Member_Ratings">
        <div class="d_Confirm_Order_style">
            ...
            <form class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
                <div class="search_style" style="margin-left: 20px">
                    <ul class="search_content clearfix">
                        <li><label class="form-label col-xs-4 col-sm-2">文件：</label><input type="file" name="file" class="input-file" id="file"></li>
                        <li><button onClick="importUsers();" class="btn btn-primary radius" type="button"><i class="Hui-iconfont">&#xe632;</i> 导入数据</button></li>
                    </ul>
                </div>
            </form>
            <form method="post" action="user_list">
                <div class="search_style" style="margin-left: 20px">
                    <ul class="search_content clearfix">
                        <li><label class="l_f">登录帐号</label><input name="name" type="text" value=""
                                                                   class="text_add" style=" width:200px"/></li>
                        <li><label class="l_f">学号/工号</label><input name="number" type="text" value=""
                                                                 class="text_add" style=" width:200px"/></li>
                        <li><label class="l_f">手机号码</label><input name="phone" type="text" value=""
                                                                    class="text_add" style=" width:200px"/></li>
                        <li><label class="l_f">班级</label><input name="bj" type="text" value=""
                                                                    class="text_add" style=" width:200px"/></li>
                        <li><label class="l_f">真实姓名</label><input name="realName" type="text" value=""
                                                                    class="text_add" style=" width:200px"/></li>
                        <li style="width:90px;">
...
<c:if test="${role.enName == 'admin'}">
    ...
    <div class="margin clearfix">
            ...
            <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                ...
                <c:forEach items="${pgs}" var="c" varStatus="l">
                    <tr>
                        ...
                        <td class="hidden-480">${c.number}</td>
        ...
        <!-- 分页开始 -->
        <div class="pagelist">
            <pg:pager url="${ctx}/user_list" maxIndexPages="5" items="${pagers.total}" maxPageItems="5"
...
<script type="text/javascript">
    ...
    function edit(id) {
        layer.open({
            type: 2,
            area: ['910px', '500px'],
            content: ['user_edit?id=' + id, 'no']  //这里content是一个URL，如果你不想让iframe出现滚动条，你还可以content: ['http://sentsin.com', 'no']
        });
    ...
    function add() {
        layer.open({
            type: 2,
            area: ['710px', '600px'],
            content: ['user_add', 'no']  //这里content是一个URL，如果你不想让iframe出现滚动条，你还可以content: ['http://sentsin.com', 'no']
        });
